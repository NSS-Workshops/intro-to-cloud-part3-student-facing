...
2. Replace `your-unique-storage-bucket-name` with a unique name. This bucket will hold the images we upload from the client. We will cover this in later chapters. Suggestion: "rock-of-ages-images-initials" replace initials with your initials 
